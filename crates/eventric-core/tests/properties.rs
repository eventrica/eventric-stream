...
#[test]
fn stream_properties_new() -> Result<(), Error> {
...
#[test]
fn stream_properties_before_and_after_append_ok() -> Result<(), Error> {
...
#[test]
fn stream_properties_before_and_after_append_err() -> Result<(), Error> {
    let mut stream = Stream::builder(eventric_core::temp_path())
        .temporary(true)
        .open()?;
...
#[test]
fn stream_properties_across_drop_and_open() -> Result<(), Error> {

...
// impl Indices {
//     #[must_use]
//     pub fn contains(&self, selection: &SelectionHash, from: Option<Position>)
// -> bool {         self.iterate(selection, from).any(|_| true)
//     }
// }
...
// impl Indices {
//     #[must_use]
//     pub fn iterate(&self, selection: &SelectionHash, from: Option<Position>)
// -> PositionIter {         OrIter::combine(selection.as_ref().iter().

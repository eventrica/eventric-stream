...
fn iterate_queries() -> Result<(), Error> {
    ...
    assert_eq!(events.len(), 3);
    assert_eq!((events[0].position(), events[0].mask()), (&Position::new(0), &Mask::new(vec![true])));
    assert_eq!((events[1].position(), events[1].mask()), (&Position::new(2), &Mask::new(vec![true])));
    assert_eq!((events[2].position(), events[2].mask()), (&Position::new(4), &Mask::new(vec![true])));
    ...
    assert_eq!(events.len(), 2);
    assert_eq!((events[0].position(), events[0].mask()), (&Position::new(0), &Mask::new(vec![true, false])));
    assert_eq!((events[1].position(), events[1].mask()), (&Position::new(1), &Mask::new(vec![false, true])));
    ...
    assert_eq!(events.len(), 3);
    assert_eq!((events[0].position(), events[0].mask()), (&Position::new(0), &Mask::new(vec![true, true])));
    assert_eq!((events[1].position(), events[1].mask()), (&Position::new(2), &Mask::new(vec![true, true])));
    assert_eq!((events[2].position(), events[2].mask()), (&Position::new(4), &Mask::new(vec![true, false])));
    ...
    assert_eq!(events.len(), 2);
    assert_eq!((events[0].position(), events[0].mask()), (&Position::new(2), &Mask::new(vec![true, true])));
    assert_eq!((events[1].position(), events[1].mask()), (&Position::new(4), &Mask::new(vec![true, false])));
    ...
    assert_eq!(events.len(), 2);
    assert_eq!((events[0].position(), events[0].mask()), (&Position::new(4), &Mask::new(vec![true, false])));
    assert_eq!((events[1].position(), events[1].mask()), (&Position::new(2), &Mask::new(vec![true, true])));
